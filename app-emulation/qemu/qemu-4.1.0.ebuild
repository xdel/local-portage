...
IUSE="accessibility +aio alsa bzip2 capstone +caps +curl debug doc
	...
	spice static static-user systemtap tci test usb usbredir vde
...
PATCHES=(
	...
	"${FILESDIR}"/microvm/v3-1-4-hw-virtio-Factorize-virtio-mmio-headers.diff
	"${FILESDIR}"/microvm/v3-2-4-hw-i386-Add-an-Intel-MPTable-generator.diff
	"${FILESDIR}"/microvm/v3-3-4-hw-i386-Factorize-PVH-related-functions.diff
	"${FILESDIR}"/microvm/v3-4-4-hw-i386-Introduce-the-microvm-machine-type.diff
	"${FILESDIR}"/microvm/v3-fixup-on-top-of-4-1-0-rc2.diff
)
