...
SLOT="0"
SDCC_PORTS="
	avr ds390 ds400 gbz80 hc08 mcs51 pdk14 pdk15 pic14 pic16 r2k r3ka s08
	stm8 tlcs90 z180 z80
"
IUSE="
	${SDCC_PORTS}
...
src_configure() {
	...
	econf \
		...
		$(use_enable non-free) \
		$(use_enable pdk14 enable_pdk14_port) \
		$(use_enable pdk15 enable_pdk15_port) \
		$(use_enable packihx) \
