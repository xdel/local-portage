...
#JCPP_VER="1.4.13"
#JCPP_COMMIT="71462c702097cabf8304202c740f780285fc35a8"
...
#	https://github.com/shevek/jcpp/archive/${JCPP_COMMIT}.tar.gz -> jcpp-${JCPP_VER}.tar.gz"
...
java_prepare() {
#	tar -xf ${DISTDIR}/jcpp-${JCPP_VER}.tar.gz -C ${S}/
#	rmdir ${S}/jcpp
#	mv ${S}/jcpp-${JCPP_COMMIT} ${S}/jcpp
	rm -rf make/lib
