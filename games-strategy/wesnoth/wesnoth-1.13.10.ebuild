...
RDEPEND=">=media-libs/libsdl2-2.0.4[joystick,video,X]
	!dedicated? (
		fribidi? ( dev-libs/fribidi )
		dbus? ( sys-apps/dbus )
		sys-libs/zlib
		dev-libs/openssl
		>=media-libs/sdl2-image-1.2[jpeg,png]
		>=media-libs/sdl2-mixer-1.2.12[vorbis]
		>=media-libs/sdl2-net-1.2
		>=media-libs/sdl2-ttf-2.0.8
		x11-libs/pango
		dev-lang/lua:0
