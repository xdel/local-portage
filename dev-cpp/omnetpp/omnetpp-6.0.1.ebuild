...
SRC_URI="https://github.com/omnetpp/omnetpp/archive/refs/tags/${P}.tar.gz"
...
#	epatch "${FILESDIR}"/wish-configure.patch
	...
	cp -a configure.user.dist configure.user
...
src_install() {
	local dirs="bin ui images lib include misc python samples"
	dodir /opt/${P}
