...
if [[ ${PV} == "9999" ]] ; then
        ...
        KEYWORDS="~amd64 ~hppa"
        SRC_URI="https://github.com/gost-engine/engine/archive/9b492b334213ea6dfb76d746e93c4b69a4b36175.tar.gz -> ${P}.tar.gz"
        S="${WORKDIR}/engine-9b492b334213ea6dfb76d746e93c4b69a4b36175"
fi
