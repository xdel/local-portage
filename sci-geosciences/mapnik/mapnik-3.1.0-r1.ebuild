...
SRC_URI="
	...
	test? (
		https://github.com/mapnik/test-data/archive/v${PV}.tar.gz -> ${PN}-test-data-${PV}.tar.gz
		https://github.com/mapnik/test-data-visual/archive/v${PV}.tar.gz -> ${PN}-test-data-visual-${PV}.tar.gz
	)"
