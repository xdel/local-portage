...
PATCHES=(
	...
	"${FILESDIR}/tdesktop-4.12.2-disable-libdispatch.diff"
)
...
src_prepare() {
	...
	# Remove libdispatch due to frequent crashes
	rm -r Telegram/ThirdParty/dispatch/ || die "haven't found libdispatch directory"
