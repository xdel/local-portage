...
src_compile() {
	go build -mod vendor -v -work -o "bin/v2ray" -trimpath -ldflags "-s -w" ./main
	if use tool; then
		go build -mod vendor -v -work -o "bin/v2ctl" -trimpath -ldflags "-s -w" -tags confonly ./infra/control/main
	fi
}
