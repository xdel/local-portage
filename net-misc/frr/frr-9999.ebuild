...
CLASSLESS_BGP_PATCH=frr-bgp-classless.patch
...
IUSE="bgpclassless caps datacenter fpm doc elibc_glibc ipv6 multipath nhrpd ospfapi pam protobuf +readline rpki shell-access snmp zeromq"
...
src_prepare() {
	...
	use bgpclassless && epatch "${FILESDIR}/${CLASSLESS_BGP_PATCH}"
