...
RDEPEND="
	...
	introspection? ( >=dev-libs/gobject-introspection-1.42.0:= gui-libs/gtk[introspection] )
...
src_configure() {
	local introspection=disabled
	use introspection && local introspection=enabled
	local emesonargs=(
