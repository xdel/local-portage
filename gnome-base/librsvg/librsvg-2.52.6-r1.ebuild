...
src_prepare() {
	...
	sed -i 's/0d441fe9edd449cfe1a9cb8aad04db57e80be310a80d6eb8c8092f67b4228b5a/cbd08e5cf3420595aaf82cd7fd25864f6c703d2eb8cd31e5831731a257da8b8a/g' \
		"${WORKDIR}/${P}"/vendor/cfg-expr/.cargo-checksum.json
