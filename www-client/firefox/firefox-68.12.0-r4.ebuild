...
CDEPEND="
	...
	system-libvpx? ( media-libs/libvpx:0[postproc] )
...
src_prepare() {
	...
	eapply "${FILESDIR}/libvpx-1.8.2/01-update-libvpx-to-1.8.2.patch"
	eapply "${FILESDIR}/libvpx-1.8.2/02-embedded-libvpx-run-update-source-script.patch"
	eapply "${FILESDIR}/libvpx-1.8.2/03-update-scripts-for-libvpx-1.8.2.patch"
	eapply "${FILESDIR}/libvpx-1.8.2/04-disable-flexiblemode-in-vp9.patch"
	eapply "${FILESDIR}/moz-sctp-cve-2020-16044.patch"
	# Fix compilation with Rust 1.48 and newer, fails for sandbox
	eapply "${FILESDIR}"/rust-1.48.patch
	eapply "${FILESDIR}"/rust-1.50.patch
	rm -r "${S}"/third_party/rust/cfg-if || die
	eapply "${FILESDIR}"/cfg-if-0.1.10.patch
	eapply "${FILESDIR}"/mozilla68-cfg-if.patch
	eapply "${FILESDIR}"/indexedDB.patch
	eapply "${FILESDIR}"/std.patch
	eapply "${FILESDIR}"/avoid-debug-assertion.patch
