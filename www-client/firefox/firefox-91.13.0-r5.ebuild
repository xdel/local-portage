...
src_prepare() {
	...
	eapply "${FILESDIR}"/moz-rust-1.66-firefox-91.patch
	eapply "${FILESDIR}"/moz-91-glibc-2.36.patch
	...
	eapply "${FILESDIR}"/91-esr-webp.diff
	eapply "${FILESDIR}"/vp8-cve.patch
	eapply "${FILESDIR}"/moz-91-tooltip.patch
	#eapply "${FILESDIR}"/jit1-cve.patch
	#eapply "${FILESDIR}"/jit2-cve.patch
