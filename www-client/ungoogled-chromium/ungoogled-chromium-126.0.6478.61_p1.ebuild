...
CROMITE_COMMIT_ID="a1d6a33b87d1f9fb1bb6a99a7ab76e99212a2120"
...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-missing-header-in-perfetto.patch"
		"${FILESDIR}/chromium-126-fix-gn-sequence.patch"
		"${FILESDIR}/chromium-126-ui-tab-missing-include.patch"
	)
