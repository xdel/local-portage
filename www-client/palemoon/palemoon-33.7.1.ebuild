...
GCC_SUPPORTED_VERSIONS="7.5 8.5 9.3 9.4 10.3 11.3 12.2 12.3 12.4 13.2 13.3 14.1 14.2"
...
src_install() {
	...
	einfo "Copying desktop file..."
	mkdir -p ${D}/usr/share/applications/ || die
	cat "${FILESDIR}"/palemoon.desktop | tee ${D}/usr/share/applications/palemoon.desktop
